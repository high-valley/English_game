...
## 作成済みの画像
`js/card_art.js` の `CARD_IMG_NAMES` に登録済み（この19語は、絵文字ではなく画像で表示されます）。
...
**7. water**（水）
```
soft hand-painted anime illustration, visible brush texture, matte finish, gentle natural light, warm and clear colors, storybook feel, one clear subject, a simple background that shows the place, few magical effects. Scene: A green slime floats in the cold water. The water itself is the main subject of the picture: large, centered and clearly visible. Any creature has big clear eyes looking toward the viewer and a charming, readable face, like a game mascot. slimes are smooth rounded domes of translucent green jelly, about the size of a melon, with two big round eyes and a small simple mouth. The world is European high fantasy: stone castles, cobbled roads, cloaks, swords and lanterns. When several people appear, each has a clearly different face, age and build. not photorealistic, not a 3D render, no glossy plastic shine, no lens flare, no heavy bloom, 3:2 wide landscape, the subject is large and centered and fills most of the frame, important parts kept inside the middle horizontal band, no text, no letters, no logo, no border, no frame
```
...
**12. moon**（月）
```
soft hand-painted anime illustration, visible brush texture, matte finish, gentle natural light, warm and clear colors, storybook feel, one clear subject, a simple background that shows the place, few magical effects. Scene: A gray wolf howls at the moon. The moon itself is the main subject of the picture: large, centered and clearly visible. Any creature has big clear eyes looking toward the viewer and a charming, readable face, like a game mascot. wolves are lean and grey with thick fur, amber eyes and dark markings on the muzzle. The world is European high fantasy: stone castles, cobbled roads, cloaks, swords and lanterns. When several people appear, each has a clearly different face, age and build. not photorealistic, not a 3D render, no glossy plastic shine, no lens flare, no heavy bloom, 3:2 wide landscape, the subject is large and centered and fills most of the frame, important parts kept inside the middle horizontal band, no text, no letters, no logo, no border, no frame
```
...
**15. come**（来る）
```
soft hand-painted anime illustration, visible brush texture, matte finish, gentle natural light, warm and clear colors, storybook feel, one clear subject, a simple background that shows the place, few magical effects. Scene: The kobolds come from the dark forest. Make the sentence's action (come) the main subject: large, centered and clearly visible. Any creature has big clear eyes looking toward the viewer and a charming, readable face, like a game mascot. kobolds are small lizard folk, knee-high, with scaled green, blue or orange skin, big round eyes, a short snout and a ragged hooded cloak. The world is European high fantasy: stone castles, cobbled roads, cloaks, swords and lanterns. When several people appear, each has a clearly different face, age and build. not photorealistic, not a 3D render, no glossy plastic shine, no lens flare, no heavy bloom, 3:2 wide landscape, the subject is large and centered and fills most of the frame, important parts kept inside the middle horizontal band, no text, no letters, no logo, no border, no frame
```
...
**120. door**（ドア）
```
soft hand-painted anime illustration, visible brush texture, matte finish, gentle natural light, warm and clear colors, storybook feel, one clear subject, a simple background that shows the place, few magical effects. Scene: An imp knocks on the heavy door. The door itself is the main subject of the picture: large, centered and clearly visible. Any creature has big clear eyes looking toward the viewer and a charming, readable face, like a game mascot. imps are tiny and red-skinned with small horns, bat wings and a thin barbed tail. The world is European high fantasy: stone castles, cobbled roads, cloaks, swords and lanterns. When several people appear, each has a clearly different face, age and build. not photorealistic, not a 3D render, no glossy plastic shine, no lens flare, no heavy bloom, 3:2 wide landscape, the subject is large and centered and fills most of the frame, important parts kept inside the middle horizontal band, no text, no letters, no logo, no border, no frame
```

**121. window**（窓）
```
soft hand-painted anime illustration, visible brush texture, matte finish, gentle natural light, warm and clear colors, storybook feel, one clear subject, a simple background that shows the place, few magical effects. Scene: A bat flies in through the window. The window itself is the main subject of the picture: large, centered and clearly visible. Any creature has big clear eyes looking toward the viewer and a charming, readable face, like a game mascot. bats are small and fuzzy with dark violet fur, large round ears and big round eyes. The world is European high fantasy: stone castles, cobbled roads, cloaks, swords and lanterns. When several people appear, each has a clearly different face, age and build. not photorealistic, not a 3D render, no glossy plastic shine, no lens flare, no heavy bloom, 3:2 wide landscape, the subject is large and centered and fills most of the frame, important parts kept inside the middle horizontal band, no text, no letters, no logo, no border, no frame
```
...
**284. ability**（能力）
```
rich painted anime fantasy illustration, dramatic lighting, golden accents, floating light particles, detailed scene. Scene: A vampire has the ability to turn into a bat. The ability itself is the main subject of the picture: large, centered and clearly visible. Any creature has clear expressive eyes and a readable face. vampires are pale and sharp-featured with red eyes, white hair, long fangs and a high-collared crimson and black cloak. bats are small and fuzzy with dark violet fur, large round ears and big round eyes. The people are dressed so that their role in the sentence is obvious at a glance. The world is European high fantasy: stone castles, cobbled roads, cloaks, swords and lanterns. When several people appear, each has a clearly different face, age and build. 3:2 wide landscape, the subject is large and centered and fills most of the frame, important parts kept inside the middle horizontal band, no text, no letters, no logo, no border, no frame
```
