...
**33. problem**（問題）
```
hand-painted anime fantasy illustration, visible brush texture, matte finish, a small magical touch, gentle glow, slightly richer details, clear subject. Scene: The orcs in the hills are a real problem. The problem itself is the main subject of the picture: large, centered and clearly visible. Any creature has clear expressive eyes and a readable face. not photorealistic, not a 3D render, no glossy plastic shine, 3:2 wide landscape, the subject is large and centered and fills most of the frame, important parts kept inside the middle horizontal band, no text, no letters, no logo, no border, no frame
```
