...
※ **COMMON だけ**を図鑑の並び順で出しています。COMMON で画像がまだ無いのは **76語**、ここにはそのうち **76語**。（全レアリティ合わせての残りは 472語）
