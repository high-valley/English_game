...
※ **COMMON だけ**を図鑑の並び順で出しています。COMMON で画像がまだ無いのは **57語**、ここにはそのうち **57語**。（全レアリティ合わせての残りは 453語）
