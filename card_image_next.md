...
※ **COMMON だけ**を図鑑の並び順で出しています。COMMON で画像がまだ無いのは **37語**、ここにはそのうち **37語**。（全レアリティ合わせての残りは 433語）
