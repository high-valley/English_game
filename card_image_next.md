...
※ **COMMON だけ**を図鑑の並び順で出しています。COMMON で画像がまだ無いのは **16語**、ここにはそのうち **16語**。（全レアリティ合わせての残りは 412語）
...
## Lv.1 COMMON（この一覧に16語）

### 1. live（住む）　id 165　敵役: goblin
