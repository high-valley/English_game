...
※ **COMMON だけ**を図鑑の並び順で出しています。COMMON で画像がまだ無いのは **52語**、ここにはそのうち **52語**。（全レアリティ合わせての残りは 448語）
...
## Lv.1 COMMON（この一覧に52語）

### 1. bridge（橋）　id 128　敵役: kobold
