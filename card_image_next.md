...
※ **COMMON だけ**を図鑑の並び順で出しています。COMMON で画像がまだ無いのは **84語**、ここにはそのうち **84語**。（全レアリティ合わせての残りは 481語）
