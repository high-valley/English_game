...
※ **COMMON だけ**を図鑑の並び順で出しています。COMMON で画像がまだ無いのは **78語**、ここにはそのうち **78語**。（全レアリティ合わせての残りは 474語）
