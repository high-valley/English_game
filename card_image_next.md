...
※ **COMMON だけ**を図鑑の並び順で出しています。COMMON で画像がまだ無いのは **87語**、ここにはそのうち **87語**。（全レアリティ合わせての残りは 484語）
