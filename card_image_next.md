...
※ **COMMON だけ**を図鑑の並び順で出しています。COMMON で画像がまだ無いのは **80語**、ここにはそのうち **80語**。（全レアリティ合わせての残りは 476語）
...
## Lv.1 COMMON（この一覧に80語）

### 1. big（大きい）　id 20　敵役: spider
