...
※ **COMMON だけ**を図鑑の並び順で出しています。COMMON で画像がまだ無いのは **62語**、ここにはそのうち **62語**。（全レアリティ合わせての残りは 458語）
