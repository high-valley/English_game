...
※ **COMMON だけ**を図鑑の並び順で出しています。COMMON で画像がまだ無いのは **72語**、ここにはそのうち **72語**。（全レアリティ合わせての残りは 468語）
