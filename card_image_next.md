...
※ **COMMON だけ**を図鑑の並び順で出しています。COMMON で画像がまだ無いのは **42語**、ここにはそのうち **42語**。（全レアリティ合わせての残りは 438語）
