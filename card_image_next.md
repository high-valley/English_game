...
※ **COMMON だけ**を図鑑の並び順で出しています。COMMON で画像がまだ無いのは **88語**、ここにはそのうち **88語**。（全レアリティ合わせての残りは 488語）
