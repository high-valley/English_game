...
※ **COMMON だけ**を図鑑の並び順で出しています。COMMON で画像がまだ無いのは **67語**、ここにはそのうち **67語**。（全レアリティ合わせての残りは 463語）
...
## Lv.1 COMMON（この一覧に67語）

### 1. fire（火）　id 113　敵役: goblin
