...
const CARD_IMG_NAMES=["apple","baby","bed","big","bird","book","boy","bread","bridge","cake","car","castle","cat","chair","come","dog","door","drink","eat","egg","family","fire","fish","flower","food","friend","girl","go","happy","horse","house","king","man","milk","moon","mountain","necessary","queen","rain","require","rice","river","road","room","run","school","sea","significant","sleep","snow","stakeholder","star","sun","table","tea","teacher","town","tree","water","wind","window","woman"];
