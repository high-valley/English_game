...
const CARD_IMG_NAMES=["answer","apple","arrive","baby","bag","beautiful","bed","believe","bicycle","big","bird","black","blue","book","box","boy","bread","bridge","brother","buy","cake","car","castle","cat","cave","chair","close","cold","color","come","continue","decide","desert","different","difficult","doctor","dog","door","dream","drink","eat","egg","experience","family","fast","fire","fish","flower","fly","food","forest","forget","friend","future","garden","gate","girl","give","go","good","hand","happy","hat","help","holiday","horse","hospital","hot","house","important","island","jump","key","king","kitchen","learn","letter","library","listen","live","love","make","man","map","market","milk","moon","morning","mother","mountain","necessary","new","night","number","old","open","play","possible","problem","queen","question","rain","read","reason","red","remember","require","rice","river","road","room","run","school","sea","see","ship","significant","sing","sister","sit","sleep","small","snow","speak","stakeholder","star","station","story","strong","summer","sun","swim","sword","table","tea","teacher","ticket","together","tower","town","travel","tree","usually","village","walk","water","weather","white","wind","window","winter","woman","work","write"];
