...
const CARD_IMG_NAMES=["apple","big","bird","book","bread","cake","car","cat","come","dog","door","drink","eat","egg","family","fire","fish","flower","food","friend","go","happy","horse","house","milk","moon","mountain","necessary","rain","require","rice","river","run","school","sea","significant","sleep","snow","stakeholder","star","sun","table","tea","tree","water","wind","window"];
