...
const CARD_IMG_NAMES=["apple","baby","bag","bed","big","bird","book","box","boy","bread","bridge","cake","car","castle","cat","chair","come","doctor","dog","door","drink","eat","egg","family","fire","fish","flower","fly","food","friend","girl","go","hand","happy","hat","horse","house","key","king","man","milk","moon","morning","mountain","necessary","night","queen","rain","require","rice","river","road","room","run","school","sea","see","significant","sit","sleep","snow","stakeholder","star","sun","swim","sword","table","tea","teacher","town","tree","walk","water","wind","window","woman"];
