...
const CARD_IMG_NAMES=["answer","apple","arrive","ask","baby","bag","beautiful","bed","believe","bicycle","big","bird","black","blue","book","box","boy","brave","bread","bridge","bring","brother","buy","cake","candle","car","careful","carry","castle","cat","catch","cave","chair","choose","clever","climb","close","cold","color","come","continue","cook","cross","crown","dance","dangerous","decide","desert","different","difficult","doctor","dog","door","draw","dream","drink","eat","egg","empty","enjoy","experience","explain","family","famous","fast","father","find","fire","fish","flower","fly","follow","food","forest","forget","friend","future","garden","gate","girl","give","go","good","hand","happy","hat","heavy","help","holiday","horse","hospital","hot","house","important","island","join","jump","key","king","kitchen","learn","leave","letter","library","listen","live","love","make","man","map","market","meet","milk","mirror","moon","morning","mother","mountain","necessary","new","night","number","old","open","play","possible","problem","protect","queen","question","quiet","rain","read","reason","red","remember","require","rice","ring","river","road","room","run","safe","save","school","sea","search","see","send","share","shield","ship","show","significant","sing","sister","sit","sleep","small","snow","speak","stakeholder","star","station","story","strong","summer","sun","swim","sword","table","tea","teach","teacher","ticket","tired","together","tower","town","travel","tree","umbrella","usually","village","visit","wait","walk","water","weather","white","wind","window","winter","woman","work","write"];
