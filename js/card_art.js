...
const CARD_IMG_NAMES=["apple","baby","bag","beautiful","bed","big","bird","black","blue","book","box","boy","bread","bridge","buy","cake","car","castle","cat","chair","close","cold","come","different","doctor","dog","door","drink","eat","egg","family","fast","fire","fish","flower","fly","food","friend","girl","give","go","good","hand","happy","hat","help","horse","hot","house","important","jump","key","king","listen","live","love","make","man","milk","moon","morning","mountain","necessary","new","night","old","open","play","queen","rain","read","red","require","rice","river","road","room","run","school","sea","see","significant","sing","sit","sleep","small","snow","speak","stakeholder","star","strong","sun","swim","sword","table","tea","teacher","together","town","tree","usually","walk","water","white","wind","window","woman","work","write"];
