...
const CARD_IMG_NAMES=["apple","baby","bag","bed","big","bird","book","box","boy","bread","bridge","buy","cake","car","castle","cat","chair","close","cold","come","doctor","dog","door","drink","eat","egg","family","fast","fire","fish","flower","fly","food","friend","girl","give","go","hand","happy","hat","help","horse","hot","house","jump","key","king","listen","live","love","make","man","milk","moon","morning","mountain","necessary","new","night","old","open","play","queen","rain","read","require","rice","river","road","room","run","school","sea","see","significant","sing","sit","sleep","small","snow","speak","stakeholder","star","sun","swim","sword","table","tea","teacher","town","tree","walk","water","wind","window","woman","work","write"];
