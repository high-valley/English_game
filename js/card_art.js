...
const CARD_IMG_NAMES=["apple","baby","bag","bed","big","bird","book","box","boy","bread","bridge","cake","car","castle","cat","chair","come","doctor","dog","door","drink","eat","egg","family","fire","fish","flower","food","friend","girl","go","hand","happy","hat","horse","house","key","king","man","milk","moon","morning","mountain","necessary","night","queen","rain","require","rice","river","road","room","run","school","sea","see","significant","sleep","snow","stakeholder","star","sun","sword","table","tea","teacher","town","tree","water","wind","window","woman"];
