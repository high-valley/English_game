...
const CARD_IMG_NAMES=["apple","baby","bag","bed","big","bird","book","box","boy","bread","bridge","cake","car","castle","cat","chair","come","doctor","dog","door","drink","eat","egg","family","fire","fish","flower","food","friend","girl","go","happy","horse","house","key","king","man","milk","moon","mountain","necessary","queen","rain","require","rice","river","road","room","run","school","sea","significant","sleep","snow","stakeholder","star","sun","sword","table","tea","teacher","town","tree","water","wind","window","woman"];
