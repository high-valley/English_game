...
const CARD_IMG_NAMES=["always","answer","apple","arrive","ask","baby","bag","beautiful","bed","believe","bicycle","big","bird","black","blue","book","box","boy","brave","bread","bridge","bring","brother","buy","cake","candle","car","careful","carry","castle","cat","catch","cave","chair","choose","clever","climb","close","cold","color","come","consider","continue","cook","cross","crown","dance","dangerous","decide","desert","develop","different","difficult","doctor","dog","door","draw","dream","drink","eat","effective","egg","empty","enjoy","environment","experience","explain","family","famous","fast","father","finally","find","fire","fish","flower","fly","follow","food","forest","forget","friend","future","garden","gate","girl","give","go","good","hand","happy","hat","heavy","help","holiday","horse","hospital","hot","house","important","improve","increase","island","join","jump","key","king","kitchen","learn","leave","letter","library","listen","live","love","make","man","map","market","meet","milk","mirror","moon","morning","mother","mountain","necessary","never","new","night","number","old","open","opportunity","play","possible","problem","protect","queen","question","quiet","rain","read","ready","reason","red","reduce","relationship","remember","require","responsibility","rice","ring","river","road","room","run","safe","save","school","sea","search","see","send","share","shield","ship","show","significant","sing","sister","sit","sleep","small","snow","speak","special","stakeholder","star","station","story","strong","suddenly","suggest","summer","sun","swim","sword","table","tea","teach","teacher","ticket","tired","together","tower","town","travel","tree","umbrella","usually","village","visit","wait","walk","water","weather","white","wind","window","winter","woman","work","write"];
