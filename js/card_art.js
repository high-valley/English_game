...
const CARD_IMG_NAMES=["apple","arrive","baby","bag","beautiful","bed","believe","big","bird","black","blue","book","box","boy","bread","bridge","buy","cake","car","castle","cat","chair","close","cold","come","continue","decide","different","difficult","doctor","dog","door","drink","eat","egg","experience","family","fast","fire","fish","flower","fly","food","forest","forget","friend","future","garden","girl","give","go","good","hand","happy","hat","help","horse","hot","house","important","island","jump","key","king","kitchen","learn","listen","live","love","make","man","market","milk","moon","morning","mountain","necessary","new","night","old","open","play","possible","problem","queen","rain","read","reason","red","remember","require","rice","river","road","room","run","school","sea","see","significant","sing","sit","sleep","small","snow","speak","stakeholder","star","strong","sun","swim","sword","table","tea","teacher","together","town","travel","tree","usually","village","walk","water","white","wind","window","woman","work","write"];
