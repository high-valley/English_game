...
function lvUp(r){
  ...
  d.innerHTML=`<i class="lvup-rays"></i><div class="lvup-in">${r.up?`<div class="lvup-t">LEVEL UP!</div><div class="lvup-n">Lv.${n}</div><div class="lvup-s">Lv.${n-1} クリア！ Lv.${n} が解放されました</div><div class="lvup-s">ガチャの排出率が更新されました</div><div class="rates-row">${rates}</div>`:`<div class="lvup-t">ALL CLEAR!</div><div class="lvup-n">全レベルクリア</div><div class="lvup-s">おめでとうございます！ これからも自由に勉強できます</div>`}
